## v1439
- **leichtathletik.de-Import: bekannte Athlet:innen unter fremdem Verein werden gefunden.** Der Importer übernahm nur Zeilen, deren Vereinsangabe zum eigenen Vereinskürzel passte – wer für eine Startgemeinschaft, eine Schule oder den alten Verein gemeldet war, fiel vollständig aus dem Import. Die Checkbox „Auch inaktive Athleten" konnte daran nichts ändern, denn sie greift erst beim Zuordnen bereits eingelesener Namen. Jetzt werden solche Zeilen wie bei RaceResult und Seltec gegen die Athletenliste geprüft und als externes Ergebnis mit Vereinsangabe übernommen; der Jahrgang muss zum Stammsatz passen, damit häufige Namen keine Fehltreffer erzeugen.
- **leichtathletik.de-Import: Debug-Log zeigt jetzt, warum jemand fehlt.** Ergänzt um die Zahl der gescannten Zeilen, die Extern-Treffer mit Verein und die 15 häufigsten Vereinsschreibweisen der Veranstaltung.
- **Bulk-Import gleicht die Veranstaltung vorab mit der Datenbank ab.** Neuer Endpunkt `veranstaltungen/match` bewertet bestehende Veranstaltungen nach Datum (±1 Tag), Name und Ort. Bei sicherem Treffer schaltet das Bulk-Eintragen automatisch auf „Bestehende wählen" und wählt die passende Veranstaltung vor – das gilt für alle Importquellen. Die bewerteten Kandidaten stehen im Debug-Log.
