...
- Eintragen-Seite: neues Panel „🔎 Neue Ergebnisse bei uitslagen.nl"; „📥 Ergebnisse importieren" belegt Veranstaltung/Datum/Ort vor und startet den bestehenden uitslagen.nl-Importer. Admin → System: Panel „uitslagen.nl-Scanner" mit An/Aus, Suchbegriffen, Rückblick-Fenster, Cron-URL, Statistik und „Jetzt scannen". Das Nav-Badge zählt jetzt offene Wettkämpfe + RaceResult-Funde + uitslagen.nl-Funde (`_eintragenBadgeSumme()`).
