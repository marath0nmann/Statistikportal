...
('trainer','["eigene_ergebnisse","lesen","personenbezogene_daten","athleten_details","trainingsplan_bearbeiten"]',                                                                                                                                                                                                     'Trainer*in',    1);
...
CREATE TABLE IF NOT EXISTS ergebnisse (
    ...
    startnummer           VARCHAR(20)  NULL,
    pos_gesamt            INT          NULL COMMENT 'Platzierung Gesamtwertung',
    pos_geschlecht        INT          NULL COMMENT 'Platzierung innerhalb m/w',
    schuh                 VARCHAR(120) NULL,
